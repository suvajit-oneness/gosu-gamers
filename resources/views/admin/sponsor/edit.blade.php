...
<div class="content">
   <div class="card">
      ...
      <div class="card-body">
         <form method="post" action="{{route('sponsor.update1')}}" enctype="multipart/form-data">
            @csrf
            <fieldset class="mb-3">
                  ...
                  <tbody>
                     <tr>
                      <td width="15%" class="text-right border-right text-uppercase">name *</td>
                        <td>
                           <input type="text" value="{{$sponsor->name}}" class="form-control" name="name">
                        </td>  
                     </tr>
                     <input type="hidden" value="{{$sponsor->id}}" class="form-control" name="id">
                     <tr>
                        <td width="15%" class="text-right border-right text-uppercase">Title *</td>
                        <td>
                           <input type="text" value="{{$sponsor->title}}" class="form-control" name="title">
                        </td>
                     </tr>
                     <tr>
