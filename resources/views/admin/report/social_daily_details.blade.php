        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                @if($dailyreport)
                <a href="{{URL::to('report/social_daily_detail/'.request()->get("from_date").'/'.request()->get('to_date').'/'.'export')}}" class="btn bg-teal-400 text-uppercase"> Export </a> 
               @endif  
            </div>        
      </div>
      </form>
      <div class="card-header header-elements-inline">
         <h5 class="card-title">Social Share Daily Reports</h5>
         @php @endphp
      </div>
            ...
            <div class="table-responsive">
             ...
             <table  class="table table-striped datatable-responsive">
                ...
                <tbody>
                   ...
                   ?>
                 @foreach ($dailyreport as $key => $count) 
                 <tr>
                    <td>{{$slno}}</td>
                    <td>{{$count->date}}</td>
                    <td>{{$count->count}}</td>
