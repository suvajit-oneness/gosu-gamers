        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                @if($socialreport)
                <a href="{{URL::to('report/socialmedia_detail/'.request()->get("from_date").'/'.request()->get('to_date').'/'.'export')}}" class="btn bg-teal-400 text-uppercase"> Export </a> 
               @endif  
            </div>        
      </div>
      </form>
