...
<div class="content">
   <div class="card">
      <div class="card-header header-elements-inline">
         <h5 class="card-title">platform Details</h5>
         <div class="header-elements">

            <div class="list-icons">
               <a href="{{route('platform.create')}}" class="btn bg-teal-400 list-icons-item text-primary-600 text-uppercase"><i class="fas fa-plus mr-1"></i>
               Add Platform </a>
            </div>
           ...
           <table id="example1" class="table table-striped datatable-responsive">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td> 
                     @if($data->is_active == 0)
                     <a class="badge bg-danger" href="{{ URL::to('platform/change-status/'.$data->id) }}">Inactive</a>
                     @else
                     <a class="badge bg-success" href="{{ URL::to('platform/change-status/'.$data->id) }}">Active</a>
                  </td>
                  @endif  
                  <td>
                     <div class="list-icons">
                      
                        <a class="badge bg-success" href="{{route('platform.show',$data->id)}}">Show</a>
                       
                        <a class="badge bg-primary"href="{{ route('platform.edit',$data->id) }}">Edit</a>                                            
                        ...
                        <div class="modal-dialog" style="width: 35%;">
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                 {!! Form::open(['method' => 'delete','route' => ['platform.destroy', $data->id],'style'=>'display:inline']) !!}
