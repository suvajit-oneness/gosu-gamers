         ...
         <div class="header-elements">
            ...
            <div class="list-icons">
              ...
              <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="btn bg-teal-400 text-uppercase">Set Room Password</a>
               <a href="javascript:void(0);" data-toggle="modal" data-target="#myModals1" class="btn bg-teal-400 text-uppercase">Send Email</a>               
               <button class="btn bg-teal-400 text-uppercase" id="sendEmail">Send Email To Member</button>
               <a href="{{route('teamtournamentfixture',$id)}}" class="btn bg-teal-400 text-uppercase" id="tournamentfixture">Fixture</a>
            </div>
