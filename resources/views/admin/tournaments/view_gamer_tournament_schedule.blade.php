      ...
      <div class="card-header header-elements-inline">
         ...
         <div class="header-elements">
            ...
            <div class="list-icons">
               ...
               <a href="{{route('tournamentfixture',$tournament->id)}}" class="btn bg-teal-400 text-uppercase" id="tournamentfixture">Fixture</a>
            </div>
            @endcan
         </div>
      </div>
       <form action="{{route('tournamentschedule')}}" method="post" accept-charset="utf-8" onSubmit="return gamerSelectLimit();">
         @csrf 
      <div class="row">
            <div class="col-md-2">
