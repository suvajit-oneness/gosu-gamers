...
<div class="content">
   <div class="card">
      <div><a class="list-icons-item text-teal-600" style="float:right;margin-right:80px; margin-top:10px "  href="{{ route('genre.index') }}"><i class="icon-exit ml-2"></i> Back</a></div>
      <div class="card-body">
