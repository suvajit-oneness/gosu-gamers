      ...
      <div class="card-header header-elements-inline">
         ...
         <div class="header-elements">
            ...
            <div class="list-icons">
               <a href="{{route('game.create')}}" class="btn bg-teal-400 text-uppercase"><i class="fas fa-plus mr-1"></i>Add Game <i class="mi-add-box"></i></a>
            </div>
            @endcan
         </div>
      </div>
         ...
         <table id="example1" class="table table-striped datatable-responsive">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     @if($data->is_active == 0)
                     <a class="badge bg-danger" href="{{ URL::to('game/change-status/'.$data->id) }}">Inactive</a>
                     @else
                     <a class="badge bg-success" href="{{ URL::to('game/change-status/'.$data->id) }}">Active</a>
                  </td>
                  @endif  @endcan
                  <td>
                     <div class="list-icons">@can('Gamer-Read')
                        <a class="badge bg-success" href="{{route('game.show',$data->id)}}">Show</a>
                        @endcan
                        @can('Gamer-Edit')
                        <a class="badge bg-primary"href="{{ route('game.edit',$data->id) }}">Edit</a> 
                        @endcan
                        @can('Gamer-Delete')                                           
                        ...
                        <div class="modal-dialog" style="width: 35%;">
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                 {!! Form::open(['method' => 'delete','route' => ['game.destroy', $data->id],'style'=>'display:inline']) !!}
