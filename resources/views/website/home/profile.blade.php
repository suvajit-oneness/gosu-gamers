    ...
    <section class="sponser_bg pt-5 pb-5 inner_body_bg">
      <div class="container">
          ...
          <div class="col-sm-4 col-md-3 col-xl-2">
            <div class="profile_picture_wrap">
              <div class="profile_picture">
                <img class="img-fluid" src="{{$user->image ? URL::asset($user->image) : asset('new-theme/images/user_logo.png')}}">
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-8 col-md-9 col-xl-10">
            <div class="profile_details">
              ...
              @foreach($teams as $team)
                  ...
                  @endif
              @endforeach
              <a href="{{route('gamer.edit')}}">Edit <i class="fas fa-edit"></i></a></h3>
              <ul class="mb-0">
            ...
            @endif
              <!-- <div class="d-flex mb-2 flex-wrap">
                <div class="add_game_id"><a href="{{route('gamer.tournaments.show',$user->id)}}"> Add Tournament</a></div>
                <div class="add_game_id"><a data-toggle="modal" data-target="#addTeamMember" href="#addTeamMember">Add Team Member</a></div>
                <div class="add_game_id mt-2"><a data-toggle="modal" data-target="#addGameId" href="#addGameId">Add Game ID</a>
        ...
        <div class="profile_tabs">
          ...
          <div class="add_game_id"><a href="{{route('gamer.tournaments.show',$user->id)}}"> Add Tournament</a></div>
          <div class="add_game_id"><a data-toggle="modal" data-target="#addTeamMember" href="#addTeamMember">Add Team Member</a></div>
          <div class="add_game_id"><a data-toggle="modal" data-target="#addGameId" href="#addGameId">Add Game ID</a></div>
        </div>

        <div class="row align-items-center justify-content-between feature_area mb-5">
          <div class="col-sm-4 text-center border-right mb-sm-0 mb-3" data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
          ...
          <div class="col-sm-4 text-center mb-sm-0 mb-3" data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
            <img src="{!!asset('letsgamenow/images/log_point.png')!!}">
            <h4>N/A</h4>
            <a href="#" class="white__btn">POINTS</a>
            <!-- <a href="#" class="white__btn">GOSU GAMERS POINTS</a> -->
          </div>
        </div>
  ...
  @endif
    <footer>
              ...
              <div class="col-sm-7">
                ...
                <div class="left_bar_social">
                  <ul class="mb-0 social_list">
                    <li class="facebook"><a target="_blanck" href="https://www.facebook.com/gosugamersindia"><i class="fab fa-facebook-f"></i></a></li>
                    <li class="twitter"><a target="_blanck" href="https://twitter.com/gosugamersindia"><i class="fab fa-twitter"></i></a></li>
                    <li class="instagram"><a target="_blanck" href="https://www.instagram.com/gosugamersindia/"><i class="fab fa-instagram"></i></a></li>
                    <li class="linkedin"><a target="_blanck" href="https://linkedin.com"><i class="fab fa-linkedin-in"></i></a></li>
                    <li class="youtube"><a target="_blanck" href="https://www.youtube.com/GosuGamersIndia"><i class="fab fa-youtube"></i></a></li>
                  </ul>
      ...
      <div class="bottom__footer mt-5 pt-5 pb-5">
        <p class="text-center">© 2022. Gosu Gamers</p>
      </div>
    </footer>
