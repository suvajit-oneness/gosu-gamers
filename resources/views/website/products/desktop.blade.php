...
@section("content")
  <section class="banner__area game inner">
    ...
    <h2 class="text-center">GAMING PC</h2>
        ...
        <div class="col-12 col-lg-3 col-sm-6 mb-3 mb-lg-4">
          ...
          <img src="{{URL::asset($data->image)}}" style="width:100%;">
            ...
            <h3 class="text-center">
                <a href="{{ route('products.pc-details',$data->id) }}">{{$data->title}}</a>
              </h3>
            </div>
            <a href="{{ route('products.pc-details',$data->id) }}" class="buy_btn">More Details <i class="fas fa-arrow-right"></i></a>
            <div class="hover-div">
