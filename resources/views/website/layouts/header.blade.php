<head>
    ...
    <title>{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_title') ?: "Gosu Gamers" }}</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="keywords" content="{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_keywords') ?: "Gosu Gamers" }}">
    <meta name="description" content="{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_description') ?: "Gosu Gamers" }}">
    ...
    <link href="https://letsgamenow.com/new-theme/css/fSelect.css" rel="stylesheet" type="text/css">
