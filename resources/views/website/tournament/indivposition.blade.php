...
<section class="banner__area game inner">
  ...
  <h2 class="text-center">Gamer Position</h2>
</section>
   ...
   <div class="container">
      <div class="content">
         ...
         <div class="card">
            ...
            <div class="card-body">
               <form method="post" action="{{route('gamer.positionsindiv.store')}}" enctype="multipart/form-data">
                  @csrf
                  <fieldset class="mb-3">
                        <div class="row">                  
                           @for ($i = 1; $i <= 10; $i++)
                  ...
                  <div class="text-left">
                     <div class="header-elements">
                        <button type="submit" class="btn bg-primary"><i class="fas fa-save mr-1"></i> Save</button>
                     </div>
                  </div>
               </form>
            </div>
