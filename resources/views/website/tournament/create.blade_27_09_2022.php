              ...
              <div class="row profile_upadate_field custom_layouts">
                <div class="col-md-12">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="text" name="tournament_name" id="tournament_name" class="typeahead form-control " placeholder="Tournament Name" autocomplete="off">
                      @error('name') {{$message}} @enderror
                    @if($errors->has('tournament_name'))
                    <span class="text-danger roy-vali-error"><small>{{$errors->first('tournament_name')}}</small></span>
                    @endif
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="date" name="reg_start_date" id="reg_start_date" class="form-control" autocomplete="off">
                ...
                <div class="col-md-6">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="date" name="reg_end_date" id="reg_end_date" class="form-control" autocomplete="off">
                ...
                <div class="col-md-6">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="time" name="reg_start_time" id="reg_start_time" class="form-control" autocomplete="off">
                ...
                <div class="col-md-6">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="time" name="reg_end_time" id="reg_end_time" class="form-control" autocomplete="off">
                ...
                <div class="col-md-6" id="money" style="display:none;">
                  <div class="form-group upadate_field custom_layout" >
                    ...
                    <input type="text" name="prize_money" id="prize_money" class="form-control onlyNumber" autocomplete="off">
                ...
                <div class="col-md-6" id="reward" style="display:none;">
                  <div class="form-group upadate_field custom_layout">
                      ...
                      <input type="text" name="other_reward" id="other_reward" class="form-control" autocomplete="off">
                ...
                <div class="col-md-6">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="number" name="max_players" id="max_players" class="form-control" autocomplete="off">
                ...
                <div class="col-md-12" id="roomk" style="display:none;">
                  <div class="form-group upadate_field custom_layout">
                    ...
                    <input type="number" name="room_size" id="room_size" class="form-control"  autocomplete="off"> 
                ...
                <div class="col-md-12">
                  <div class="form-group upadate_field custom_layout">
                    <label>Rules :</label>
                    <textarea name="rulesdescription" id="rulesdescription" class="form-control" rows="2"></textarea>
                  </div>
                </div>
