...
<div class="clearfix"></div>
  ...
  <div class="container">
    ...
    <div class="">
      ...
      <div class="">
      <form action="{{route('gamer.tournaments.gamertournamentschedule')}}" method="post" accept-charset="utf-8" onSubmit="return gamerSelectLimit();">
         @csrf 
        <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group upadate_field custom_layout">
                ...
                <select name="player1[]" id="player1" selected="selected" >
                    ...
                    <option value="{{$gammer->gamer_id}}">{{$gammer->fname}} {{$gammer->lname}}</option>
                    @endforeach
                </select>
                </div>
                @endfor
        ...
        <div class="row">           
          <div class="col-md-6">
            <div class="form-group upadate_field custom_layout time">
        ...
        <div class="row">           
          <div class="col-md-6">
            <div class="form-group upadate_field custom_layout date">
