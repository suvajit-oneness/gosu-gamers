...
<section class="sponser_bg pt-5 pb-5">
  ...
  <div class="container">
    <div><a href="{{ route('gamer.tournaments.show',$user->id) }}" class="btn btn-danger float-md-right my-3">Back</a>
    </div>
                ...
                <div class="chat_dive content" id="chat{{ $dataValue->gamer_id }}" >
                  ...
                  <form>
                    <div class="input-group">
                      <input type="hidden" name="tournament_id" id="tournament_id" value="{{ $dataValue->tournament_id }}">
                      <input type="hidden" name="gamer_id" id="user_id" value="{{ $userId }}">
                      <input type="hidden" name="creator" id="creator" value="{{ $userId }}">
                      <input type="hidden" name="sms_to" id="sms_to" value="{{ $gamerId }}">
