            ...
            <div class="game_banner mb-5">
               ...
               <div class="row align-items-center justify-content-between feature_area" style="margin-bottom: 60px;">
                  <div class="col-sm-3 text-center border-right" data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                     ...
                     @else
                     <a href="{{ route('home.login') }}" class="red__btn">JOIN</a>
                     @endif
                  </div>
                  <div class="col-sm-3 text-center border-right" data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="tournament_description">
                           <h4 class="title">About the Tournament</h4>
                           {!!$tournaments->description!!}
                           <h4 class="title">Rules</h4>           
                           {!!$tournaments->rulesdescription!!}
            ...
            <div class="chat_dive content" id="content">
               ...
               <form>
                  <div class="input-group">
                     <input type="hidden" name="tournament_id" id="tournament_id" value="{{ $tournaments->id }}">
                     <input type="hidden" name="user_id" id="user_id" value="{{ $userId }}">
                     <input type="hidden" name="sms_to" id="sms_to" value="{{( $tournaments->gamer_id) ?  $getcreator : "Admin" }}">
                     <input type="hidden" name="creator" id="creator" value="{{( $tournaments->gamer_id) ?  $getcreator : "Admin" }}">
                     <input type="text" class="form-control" name="sms" id="sms" placeholder="Enter here...">
...
//                console.log(items[0].tournament_id);
//                bodyData+="<tr>"
//                     bodyData+="<td>"+ i++ +"</td><td>"+items[0].tournament_id+"</td><td>"+items[0].message+"</td><td>"+items[0].sms_to+"</td>";
//                     bodyData+="</tr>";
//             });
