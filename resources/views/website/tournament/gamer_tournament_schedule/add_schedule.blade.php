...
<section class="banner__area game inner">
  ...
  <h2 class="text-center">Tournament Schedule Schedule</h2>
</section>
   ...
   <div class="container">
      <div class="content">
         ...
         <div class="card">
            ...
            <div class="card-body">
              <form action="{{route('gamer.tournaments.tournamentschedule')}}" method="post" accept-charset="utf-8" onSubmit="return gamerSelectLimit();">
                @csrf 
                <div class="row">
                    <div class="col-md-2">
