            ...
            <div class="col-sm-6 text-center p-4 p-sm-5">
                ...
                <div class="login__block">
                    ...
                    <form class="login__form" method="post" onsubmit="return ValidateReqForm();"
                          action="{{route('flipkart.reset.password.submit')}}">
                        @csrf
                        <input type="hidden" name="forgot_password_hash" value="{{ $forgot_password_hash }}">
...
<script>
    ...
    function ValidateReqForm() {
        ...
        if (password_confirmation == "") {
            ...
            swal('Please Retype Password ');
            return errorflag = false;
        }

        if (password != password_confirmation) {
            $("#password_confirmation").css('border-color', 'red');
            swal('Please Retype Password correctly');
            return errorflag = false;
        }
    }
