            ...
            <div class="col-sm-6 text-center p-4 p-sm-5">
                ...
                <div class="login__block">
                    ...
                    <form class="login__form" method="post" onsubmit="return ValidateReqForm();"
                          action="{{route('flipkart.verify.account.submit')}}">
                        @csrf
                        ...
                        <div class="form-group" data-aos="fade-zoom-in" data-aos-easing="ease-in-back"
                             data-aos-duration="1000">
                            <button type="button" class=""><span class="fas fa-shield-alt"></span></button>
                            <input type="text" name="otp" id="otp" placeholder="Please enter OTP">
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <button type="submit" class="" data-aos="fade-right" data-aos-duration="1000"
                                            data-aos-easing="ease-in-sine">Verify OTP
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group justify-content-end">
                                    <a href="{{route('flipkart.resend.otp')}}" class="signin__btn" data-aos="fade-left"
                                       data-aos-duration="1000" data-aos-easing="ease-in-sine">Resend OTP</a>
                                </div>
                            </div>
                            @endif
