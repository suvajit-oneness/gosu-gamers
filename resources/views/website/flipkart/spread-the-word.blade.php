                    ...
                    <div class="col-sm-12">
                        ...
                        {{-- <script>
                            ...
                            a2a_config.overlays.push({
                                services: ['linkedin', 'facebook', 'whatsapp', 'google_gmail'],
                                size: '50',
                                style: 'horizontal',
                            ...
                            <a href="javascript: void(0)" class="buy_btn">
                            <img src="{!!asset('flipkart/images/banners/join-flipkart-social-share-image.jpeg')!!}" class="share-image img-fluid" alt="Be a part of Flipkart's Fleet Of Gamers & earn 500 Off Coupon Code upon registration. *T&C Apply #FlipkartFleetOfGamers" longdesc="https://letsgamenow.com/flipkart-gaming/register">
                            <input type='hidden' name='userid' id='userid' value='{{$user->id}}'/>
                            </a> --}}
