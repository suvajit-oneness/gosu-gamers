...
class TournamentRoomSlotController extends Controller
    ...
    */
    ...
    public function roomwinner( $id ) {
        ...
        if ( $count == 1 ) {
            ...
            return view( 'admin.tournament_rooms.winner', compact( 'tours', 'tournament' ) );
        } elseif ( $count == 0 ) {
    ...
    public function showroom( $id )
 {
        ...
        return view( 'admin.tournament_rooms.showroomplayers', compact( 'showroomplayers', 'tournaments', 'noofroom', 'rooms' ) );
    }
    ...
    public function showteamroom( $id )
 {
        ...
        $tournaments = Tournaments::where( 'tournaments.id', $id )->first();
        return view( 'admin.tournament_rooms.showroomteam', compact( 'showroomplayers', 'tournaments', 'noofroom', 'rooms' ) );
    }
    /**
    * Show the form for creating a new resource.
    *
