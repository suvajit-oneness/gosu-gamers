...
class GamerController extends Controller {
    ...
    */
    ...
    public function update1( Request $request ) {
        ...
        Alert::Html( 'Success', '<h2> Gamer Update Successfully </h2>', 'success' );
    ...
    */
    ...
    public function gamerpositions( $id ) {
        ...
        if ( $tournament->user_type == 1 ) {
            ...
            return view( 'website.tournament.indivposition', compact( 'tournament', 'players', 'position' ) );
            ...
            ->leftJoin( 'gamers', 'teams.gamer_id', '=', 'gamers.id' )
            ->get();
            return view( 'website.tournament.teamposition', compact( 'tournament', 'players', 'position' ) );
        }
