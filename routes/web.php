...
Route::get('admin/login', 'Auth\LoginController@showLoginForm')->name('login/admin');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('deletefixture/{id}/{stage}', 'GamerTournamentScheduleController@deleteFixture')->name('deletefixture')->middleware('role:Admin');

    Route::get('team_tournament/create/{id}', 'TeamsTournamentController@create')->name('teamtournament.create')->middleware('role:Admin');
    Route::get('gamers_tournament/create/{id}', 'GamersTournamentsController@create')->name('gamers_tournament.create')->middleware('role:Admin');
...
Route::post('news/count','Website\NewsController@newsclickcount')->name('news.count');
...
Route::prefix('gamer')->name('gamer.')->group(function() {
	Route::prefix('tournaments')->name('tournaments.')->group(function() {
        ...
        Route::get('chat-list/{id}', 'Website\TournamentsController@ChatList')->name('chat-list');
	});	
});
        // Route::get('fetch_sms/{id}', 'Website\TournamentsController@fetchSMS')->name('fetch_sms');
/* Add Gamer Tournament Schedule*/
        Route::prefix('gamer')->name('gamer.')->group(function() {
            Route::prefix('tournaments')->name('tournaments.')->group(function() {
                ...
                Route::post('sms', 'Website\TournamentsController@message')->name('sms');
            });
        });
